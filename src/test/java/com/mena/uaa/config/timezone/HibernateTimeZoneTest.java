package com.mena.uaa.config.timezone;

import com.mena.uaa.MenaUaaApp;
import com.mena.uaa.repository.timezone.DateTimeWrapper;
import com.mena.uaa.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM yl_date_time_wrapper where id=%d", fieldName, id);
    }
